...
void ARP_Enemy::HealthChanged(URP_HealthComponent* CurrentHealtComponent, AActor* DamagedActor, float Damage, const UDamageType* DamageType, AController* InstigatedBy, AActor* DamageCauser)
{
	...
	if (CurrentHealtComponent->IsDead())
	{
